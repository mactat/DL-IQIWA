...
class Model(nn.Module):
    def __init__(self):
        ...
        # decoder
        self.deconv1 = nn.ConvTranspose2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1)                                           
        self.deconv2 = nn.ConvTranspose2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1)   
        self.upsample = nn.UpsamplingBilinear2d(scale_factor=4)     
        self.deconv3 = nn.ConvTranspose2d(in_channels=256, out_channels=3, kernel_size=3, stride=1, padding=1) 
